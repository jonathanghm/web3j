 ...
 * <a href="https://github.com/bowhead/go-bowhead/wiki/Contract-Tutorial">Contract Tutorial</a>
 * on the Go Bowhead Wiki.
 */
public class GreeterContractIT extends Scenario {
    ...
    private String sendCreateContractTransaction() throws Exception {
        ...
        org.web3j.protocol.core.methods.response.AhtSendTransaction
                transactionResponse = web3j.ahtSendTransaction(transaction)
                .sendAsync().get();
    ...
    private String callSmartContractFunction(
        ...
        org.web3j.protocol.core.methods.response.AhtCall response = web3j.ahtCall(
