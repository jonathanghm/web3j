...
/**
 * Simple integration test to demonstrate sending of Aht between parties.
 */
public class SendAhtIT extends Scenario {
    ...
    public void testTransferAht() throws Exception {
        ...
        Transaction transaction = Transaction.createAhtTransaction(
    ...
    public void testTransfer() throws Exception {
        TransactionReceipt transactionReceipt = Transfer.sendFunds(
                web3j, ALICE, BOB.getAddress(), BigDecimal.valueOf(0.2), Convert.Unit.AHT)
                .send();
