 ...
 */
public class AhtSyncing extends Response<AhtSyncing.Result> {

    @Override
    @JsonDeserialize(using = AhtSyncing.ResponseDeserialiser.class)
    public void setResult(AhtSyncing.Result result) {
    ...
    // these fields although not present in the RPC specification are returned by Gaht 1.4.10
