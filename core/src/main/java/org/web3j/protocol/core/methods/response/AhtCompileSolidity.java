 ...
 * aht_compileSolidity.
 */
public class AhtCompileSolidity extends Response<Map<String, AhtCompileSolidity.Code>> {
    ...
    public static class Documentation {
        ...
        // See https://github.com/bowhead/wiki/wiki/JSON-RPC#aht_compilesolidity
