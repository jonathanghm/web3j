 ...
 * <ul>
 * <li>aht_getBlockByHash</li>
 * <li>aht_getBlockByNumber</li>
 * <li>aht_getUncleByBlockHashAndIndex</li>
 * <li>aht_getUncleByBlockNumberAndIndex</li>
 * </ul>
 *
 * <p>See
 ...
 *
 * <p>See the following <a href="https://github.com/ahtcore/parity/issues/2401">issue</a> for
 * details on additional Parity fields present in AhtBlock.</p>
 */
public class AhtBlock extends Response<AhtBlock.Block> {

    @Override
    @JsonDeserialize(using = AhtBlock.ResponseDeserialiser.class)
