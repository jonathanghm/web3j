...
public interface Web3jRx {
     ...
     *
     * @param ahtFilter filter criteria
     * @return Observable that emits all Log events matching the filter
     */
    Observable<Log> ahtLogObservable(AhtFilter ahtFilter);
     ...
     *         blockchain
     */
    Observable<String> ahtBlockHashObservable();
     ...
     */
    Observable<String> ahtPendingTransactionHashObservable();
     ...
     */
    Observable<AhtBlock> blockObservable(boolean fullTransactionObjects);
     ...
     */
    Observable<AhtBlock> replayBlocksObservable(
     ...
     *                              in the {@link AhtBlock} responses
     ...
     */
    Observable<AhtBlock> catchUpToLatestBlockObservable(
     ...
     */
    Observable<AhtBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
