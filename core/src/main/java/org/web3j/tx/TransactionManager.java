...
/**
 * Transaction manager abstraction for executing transactions with Bowhead client via
 * various mechanisms.
 */
public abstract class TransactionManager {
    ...
    protected TransactionReceipt executeTransaction(
        ...
        AhtSendTransaction ahtSendTransaction = sendTransaction(
                gasPrice, gasLimit, to, data, value);
        return processResponse(ahtSendTransaction);
    }

    public abstract AhtSendTransaction sendTransaction(
            BigInteger gasPrice, BigInteger gasLimit, String to,
            String data, BigInteger value)
            throws IOException;
    ...
    private TransactionReceipt processResponse(AhtSendTransaction transactionResponse)
            throws IOException, TransactionException {
