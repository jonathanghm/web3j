...
public class WalletFile {
    ...
    public static class Crypto {
        ...
        // To support my Aht Wallet keys uncomment this annotation & comment out the above
    ...
    // If we need to work with MyAhtWallet we'll need to use this deserializer, see the
    // following issue https://github.com/kvhnuke/ahtwallet/issues/269
